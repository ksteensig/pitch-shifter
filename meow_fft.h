...
size_t meow_fft_generate_workset(int N, struct Meow_FFT_Workset* workset);
// returns the size of the workset if null is passed.

size_t meow_fft_generate_workset_real(int N,
...
void meow_fft_real(const struct Meow_FFT_Workset_Real* workset, const float* in,
                   Meow_FFT_Complex* out);

void meow_fft_real_i(const struct Meow_FFT_Workset_Real* workset,
                     const Meow_FFT_Complex* in, Meow_FFT_Complex* temp,
                     float* out);

void meow_fft(const struct Meow_FFT_Workset* data, const Meow_FFT_Complex* in,
              Meow_FFT_Complex* out);

void meow_fft_i(const struct Meow_FFT_Workset* data, const Meow_FFT_Complex* in,
                Meow_FFT_Complex* out);
...
unsigned meow_make_twiddles_sequential(unsigned n, Meow_FFT_Complex* w,
                                       Meow_Fft_Stages* stages)
...
Meow_Stage_Info meow_calculate_stages(unsigned n, Meow_FFT_Workset* workset) {
  ...
  Meow_Stage_Info result = {is_slow, stage, w_count};
...
size_t meow_fft_generate_workset(int N, Meow_FFT_Workset* workset) {
  ...
  const size_t size_twiddles_ordered = info.w_count * sizeof(Meow_FFT_Complex);

  const size_t size_twiddles = N * sizeof(Meow_FFT_Complex) * info.is_slow;

  const size_t size_total = size_workset + size_twiddles + size_radix +
                            size_remainder + size_offsets +
  ...
  if (workset) {
    ...
    workset->wn = (info.is_slow) ? (Meow_FFT_Complex*)(data_wn) : NULL;
    ...
    meow_make_twiddles_sequential(N, workset->wn_ordered, &workset->stages);
  }

  return size_total;
}

size_t meow_fft_generate_workset_real(const int N,
...
inline Meow_FFT_Complex meow_add(const Meow_FFT_Complex lhs,
                                 const Meow_FFT_Complex rhs) {
  Meow_FFT_Complex result = {lhs.r + rhs.r, lhs.j + rhs.j};

  return result;
}

inline Meow_FFT_Complex meow_sub(const Meow_FFT_Complex lhs,
                                 const Meow_FFT_Complex rhs) {
  Meow_FFT_Complex result = {lhs.r - rhs.r, lhs.j - rhs.j};
...
inline Meow_FFT_Complex meow_negate(const Meow_FFT_Complex lhs) {
  Meow_FFT_Complex result = {-lhs.r, -lhs.j};
...
inline Meow_FFT_Complex meow_mul(const Meow_FFT_Complex lhs,
                                 const Meow_FFT_Complex rhs) {
  Meow_FFT_Complex result = {(lhs.r * rhs.r) - (lhs.j * rhs.j),
...
inline Meow_FFT_Complex meow_mul_by_conjugate(const Meow_FFT_Complex lhs,
                                              const Meow_FFT_Complex rhs) {
  Meow_FFT_Complex result = {(lhs.r * rhs.r) + (lhs.j * rhs.j),
...
inline Meow_FFT_Complex meow_mul_by_j(const Meow_FFT_Complex lhs) {
  Meow_FFT_Complex result = {-lhs.j, lhs.r};

  return result;
}

inline Meow_FFT_Complex meow_mulf(const Meow_FFT_Complex lhs, float rhs) {
  Meow_FFT_Complex result = {lhs.r * rhs, lhs.j * rhs};
...
void meow_dft_n_dit(const Meow_FFT_Complex* w_n, Meow_FFT_Complex* out,
                    unsigned count, unsigned w_multiplier, unsigned radix,
                    unsigned N, unsigned reverse) {
...
void meow_radix_2_dit(const Meow_FFT_Complex* w_n, Meow_FFT_Complex* out,
                      unsigned count) {
...
void meow_radix_3_dit(const Meow_FFT_Complex* w_n, Meow_FFT_Complex* out,
                      unsigned count) {
  // W[0] is always 1.0f;
  {
...
void meow_radix_4_dit(const Meow_FFT_Complex* w_n, Meow_FFT_Complex* out,
                      unsigned count) {
  // W[0] is always 1.0f;
  {
    const unsigned i0 = 0 * count;
...
void meow_radix_5_dit(const Meow_FFT_Complex* w_n, Meow_FFT_Complex* out,
                      unsigned count) {
  // W[0] is always 1.0f;
  {
    const unsigned i0 = 0 * count;
    ...
    Complex t10j = meow_mul_by_j(meow_add(meow_mulf(t3, MEOW_SIN_2PI_5),
                                          meow_mulf(t4, MEOW_SIN_2PI_10)));

    Complex t11j = meow_mul_by_j(meow_sub(meow_mulf(t3, MEOW_SIN_2PI_10),
...
static void meow_radix_8_dit(const Meow_FFT_Complex* w_n, Meow_FFT_Complex* out,
                             unsigned count) {
...
void meow_radix_2_dit_i(const Meow_FFT_Complex* w_n, Meow_FFT_Complex* out,
                        unsigned count) {
  // butteryfly 0 always has the twiddle factor == 1.0f
  // so special case that one.
  {
...
void meow_radix_3_dit_i(const Meow_FFT_Complex* w_n, Meow_FFT_Complex* out,
                        unsigned count) {
  // W[0] is always 1.0f;
  {
    const unsigned i0 = 0 * count;
...
void meow_radix_4_dit_i(const Meow_FFT_Complex* w_n, Meow_FFT_Complex* out,
                        unsigned count) {
  // W[0] is always 1.0f;
  {
    const unsigned i0 = 0 * count;
...
void meow_radix_5_dit_i(const Meow_FFT_Complex* w_n, Meow_FFT_Complex* out,
                        unsigned count) {
  // W[0] is always 1.0f;
  {
    const unsigned i0 = 0 * count;
...
static void meow_radix_8_dit_i(const Meow_FFT_Complex* w_n,
                               Meow_FFT_Complex* out, unsigned count) {
  const float* W = &w_n[0].r;
  {
    float T3;
    float T37;
  ...
  if (count == 1) {
    ...
    for (unsigned i = 0; i < radix; ++i) {
      meow_recursive_fft_mixed_meow_radix_dit(
          fft, stage + 1, &in[w_mul * i], &out[count * i], new_w_multiplier);
    }
  }

  switch (radix) {
    case 2:
      meow_radix_2_dit(w_sequential, out, count);
      break;
    case 3:
      meow_radix_3_dit(w_sequential, out, count);
      break;
    case 4:
      meow_radix_4_dit(w_sequential, out, count);
      break;
    case 5:
      meow_radix_5_dit(w_sequential, out, count);
      break;
    case 8:
      meow_radix_8_dit(w_sequential, out, count);
      break;

    default:
      meow_dft_n_dit(w, out, count, w_mul, radix, fft->N, 0);
      break;
  }
}
...
void meow_recursive_fft_mixed_meow_radix_dit_i(const Meow_FFT_Workset* fft,
  ...
  switch (radix) {
    case 2:
      meow_radix_2_dit_i(w_sequential, out, count);
      break;
    case 3:
      meow_radix_3_dit_i(w_sequential, out, count);
      break;
    case 4:
      meow_radix_4_dit_i(w_sequential, out, count);
      break;
    case 5:
      meow_radix_5_dit_i(w_sequential, out, count);
      break;
    case 8:
      meow_radix_8_dit_i(w_sequential, out, count);
      break;

    default:
      meow_dft_n_dit(w, out, count, w_mul, radix, fft->N, 1);
      break;
  }
}
...
inline void meow_mixer(unsigned N_2, Complex* w_2n, Complex* in,
                       Meow_FFT_Complex* out) {
...
inline void meow_mixer_i(unsigned N_2, Complex* w_2n, Complex* in,
                         Meow_FFT_Complex* out) {
  const unsigned N_4 = N_2 / 2u;
...
void meow_fft_real(const Meow_FFT_Workset_Real* fft, const float* in,
                   Meow_FFT_Complex* out) {
  ...
  meow_recursive_fft_mixed_meow_radix_dit(&fft->half, 0, (Complex*)(in), out,
                                          1);
...
void meow_fft_real_i(const Meow_FFT_Workset_Real* ifft,
                     const Meow_FFT_Complex* in, Meow_FFT_Complex* temp,
                     float* out) {
  ...
  meow_recursive_fft_mixed_meow_radix_dit_i(&ifft->half, 0, temp,
                                            (Meow_FFT_Complex*)(out), 1);
}

void meow_fft(const Meow_FFT_Workset* data, const Meow_FFT_Complex* in,
              Meow_FFT_Complex* out) {
  meow_recursive_fft_mixed_meow_radix_dit(data, 0, in, out, 1);
}

void meow_fft_i(const Meow_FFT_Workset* data, const Meow_FFT_Complex* in,
                Meow_FFT_Complex* out) {
  meow_recursive_fft_mixed_meow_radix_dit_i(data, 0, in, out, 1);
}
